        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex search-box">
            ...
            <button class="btn btn-success" type="submit" value="search">
              <router-link class="search-btn" to="/search">Search Movie</router-link>
            </button>
          </form>
            ...
            <div class="movie" v-for="movie in movies" :key="movie.imdbID">
              <router-link :to="'/movie/' + movie.imdbID" class="movie-link">
                ...
                <div class="detail">
                  ...
                  <div class="year">Năm Phát Hành: {{ movie.Year }}</div>
                  <div class="type">Thể Loại: {{ movie.Type }}</div>
                </div>
              </router-link>
            </div>
          </div> -->
...
export default {
  ...
  //   const SearchMovies = () => {
  //     if (search.value !== "") {
  //       fetch(`http://www.omdbapi.com/?apikey=${api.apikey}&s=${search.value}`)
  //         .then((res) => res.json())
  //         .then((data) => {
